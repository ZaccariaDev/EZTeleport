...
Config.Framework = 'esx'  -- pour le moment il n'y a que le esx de disponible une maj arrivera pour d'autres frameworks
...
Config.Teleports = {
    {
        --exemple 1
        nom = "hopital", --un nom, pour savoir de quoi ça parle et pour définir le texte dans le fichier lang [obligatoire]
